...
set ADD_OPENS="java.xml/com.sun.org.apache.xml.internal.serialize=ALL-UNNAMED"

( echo %date% %time%
  java -cp %JAR% -Xmx"%MAXHEAP%" -splash:"%SPLASH%" --add-opens %ADD_OPENS% %OTHER_ARGS% %MAIN_CLASS%
